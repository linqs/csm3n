...
clear;
examples = noisyX(8,1,0,1,0);
Xdesc = struct('discreteX',0,'nonneg',0);
expSetup = struct('nFold',2,'foldDist',[1 1 1 1],'runAlgos',1:2,...
...
cd ../../..;
expSetup = struct('foldIdx',foldIdx(1:2),'runAlgos',[1:2 6],...
				  'Cvec',250,'CvecStab',.25,'nStabSamp',10,...
				  'decodeFunc',@UGM_Decode_LBP,'inferFunc',@UGM_Infer_LBP);
experiment;
